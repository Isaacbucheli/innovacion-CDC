...
const roleChipCls = (role: string) =>
  role === "admin" ? "bg-primary/15 text-primary"
    : role === "consultor" ? "bg-blue-100 text-blue-800 dark:bg-blue-950 dark:text-blue-200"
    : role === "monitoreo" ? "bg-emerald-100 text-emerald-800 dark:bg-emerald-950 dark:text-emerald-200"
    : NEUTRAL;
