  ...
  return (
    <div className="min-h-screen grid grid-cols-[240px_1fr] bg-secondary">
      <aside className="bg-[#0e1512] text-white flex flex-col p-4 gap-2">
        ...
        <button className="flex items-center gap-2 px-3 py-2 rounded-lg bg-primary/15 text-primary font-medium text-sm">
        ...
        <div className="mt-auto pt-4 border-t border-white/10 flex items-center justify-between text-xs text-white/60">
          ...
          <Button variant="ghost" size="icon" className="text-white/70 hover:text-white" onClick={() => { clearSession(); location.reload(); }} aria-label="Salir">
